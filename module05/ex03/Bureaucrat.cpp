...
/*   Updated: 2021/06/30 09:17:41 by gdupont          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		Bureaucrat::executeForm(Form const & theForm) {
	...
	if (this->getRank() > theForm.getRankNeededToExec())
		std::cout << this->_name << " can't executes " << theForm.getName() 
		<< " because of a too low rank exception"<< std::endl;
	else
		std::cout << this->_name << " executes " << theForm.getName() << std::endl;
